...
/**
 * Checks if the admin password provided in the request's headers is valid.
...
function validateAdminPassword(request: Request, response: Response, next: NextFunction) {
...
export default validateAdminPassword;
